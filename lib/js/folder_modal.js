...
// $("#sbm-modal").load(chrome.extension.getURL("new-folder.html"));  
chrome.extension.sendRequest({cmd: "new_folder"}, function(html){
    ...
    modal_head.append('<<script src='+chrome.extension.getURL("lib/js/new-folder.js")+'></script>');
